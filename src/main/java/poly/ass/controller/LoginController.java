...
//				System.out.println(user);
	...
	public String forgotPassword(HttpSession sess, @ModelAttribute("fpAccount") Account account,
			@RequestParam("usernameF") String un, @RequestParam("emailF") String em, BindingResult result) {
		...
		if (result.hasErrors()) {
			...
			try {
				...
				if (acc != null) {
					mailer.send(em, "Mail ForgotPassword từ ASS_SOF3021",
							"<h3>" + "Username: " + un + "<br>" + "Password: " + acc.getPassword() + "</h3>");
				}
			} catch (Exception e) {
