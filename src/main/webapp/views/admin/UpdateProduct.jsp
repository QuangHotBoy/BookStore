...
uri="http://www.springframework.org/tags/form" prefix="fr"%>
<html>
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="/Statistics.html">Trang Chủ</a>
            </li>
            <li class="breadcrumb-item">
              <a href="/Statistics.html">Sản Phẩm</a>
            </li>
     *       <li class="breadcrumb-item active">Cập Nhật Sản Phẩm</li>
      ...
      <section class="section dashboard">
        <div class="row">
          <div class="col-xl-12">
            <table class="table table-dark table-striped table-hover" id="table1">
              <thead>
                <tr>
                  <th scope="col">Mã</th>
              ...
              <tbody>
                <c:forEach var="item" items="${products}">
                  <tr>
                    ...
                    <td>
                      <a href="/product/edit/${item.product_id}">Cập nhật</a>
                    </td>
                  </tr>
                </c:forEach>
              </tbody>
                        ...
                        <div class="col-md-8 col-lg-9">
                          ...
                          <div class="pt-2">
                            ...
                            <label
                              for="formFile"
                              id="customFile"
                              onclick="defautlBtnIMG()"
                              class="btn btn-primary btn-sm"
                              ><i class="fa-solid fa-upload"></i
                            ></label>
                            <label id="deleteFile" class="btn btn-danger btn-sm"
    ...
    <footer id="footer" class="footer">
      ...
      <div class="credits">
        Designed by
        <a href="/memberInformation.html">Tùng - Thiên - Tường - Phát - Hào</a>
      </div>
    </footer>
    <div class="backTop">
